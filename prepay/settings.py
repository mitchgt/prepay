...
ADMINS = (
    ...
    ('Jennifer Lin','jennifer.lin@emory.edu'),
    ('Lara Lu', 'tlu24@emory.edu'),
    ('Michael Mitchell', 'mmitc3@emory.edu'),
    ('Zaheer Zaheer','akzahee@emory.edu'),
)
...
SECRET_KEY = '(-b#zrhg#nm2%%-gw2q&amp;@2q1pw#xzb8ri_=ytk(9&amp;trt1)#zyj'
...
MIDDLEWARE_CLASSES = (
    ...
    #'prepay.middleware.AddGroupsMiddleware',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'prepay.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'prepay.wsgi.application'
